...
Background:
	...
	Scenario: New project link is shown to admins
		Given I am signed in as "admin@ovia.in"
		And I follow "Projects"	
	...
	Scenario: New ticket link is shown to a user with permission
		Given "user@ovia.in" can view the "TextMate 2" project
		And "user@ovia.in" can create tickets in the "TextMate 2" project
		And I am signed in as "user@ovia.in"
		And I follow "Projects"	
		When I follow "TextMate 2"
